...
public partial class _2109060207DbContext : DbContext
{
    public _2109060207DbContext()
    {
    }

    public _2109060207DbContext(DbContextOptions<_2109060207DbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=rm-bp1tg219t7o5j5ex8fo.rwlb.rds.aliyuncs.com;port=3306;database=2109060207_db;user id=2109060207;password=2109060207", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.34-mysql"));
